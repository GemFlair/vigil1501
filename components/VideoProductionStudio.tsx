...
export const VideoProductionStudio: React.FC = () => {
  ...
  const getActivePrompt = () => {
    if (mode === 'CHRONICLES') return selectedChronicle.visualPrompt;
                ...
                <div className="w-full h-full flex flex-col p-8 md:p-14 relative z-10 animate-in fade-in duration-1000">
                   <div className="flex flex-col md:flex-row gap-12 items-center h-full">
                      <div className="flex-1 space-y-8 text-left">
                         <div className="space-y-4">
                            <div className="flex items-center gap-3">
                               ...
                               <span className="text-[10px] font-black text-amber-500 uppercase tracking-[0.4em]">Manual Submission Hub</span>
                            </div>
                            ...
                            <p className="text-zinc-500 text-[11px] font-medium leading-relaxed italic max-w-sm">
                         ...
                         <div className="space-y-4">
                            <div className="p-6 bg-black border border-zinc-900 rounded-[2rem] relative group shadow-inner">
                               <div className="absolute top-4 right-6 flex items-center gap-2 opacity-30">
                                  <span className="text-[8px] font-black text-zinc-500 uppercase tracking-widest">Visual_Directive</span>
                               </div>
                               <textarea 
                                 readOnly 
                                 value={getActivePrompt()}
                                 className="w-full h-32 md:h-40 bg-transparent text-[11px] font-mono text-zinc-500 focus:outline-none resize-none no-scrollbar uppercase leading-relaxed pr-8"
                               />
                               <button 
                                 onClick={() => {
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-6">
                               <button 
                                onClick={handleSelectKey}
                                className="w-full sm:w-auto px-10 py-4 bg-amber-600 text-white rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-amber-500 transition-all shadow-xl active:scale-95"
                               >
                                  AUTHORIZE VEO_NODE
                               </button>
                               <div className="hidden sm:block h-4 w-[1px] bg-zinc-900" />
                               <span className="text-[9px] font-black text-zinc-800 uppercase tracking-widest italic">v0.0.5.1 // MANUAL_OVERRIDE_ENABLED</span>
                            </div>
                         </div>
                      </div>
                      ...
                      <div className="hidden lg:flex lg:w-64 flex-col items-center gap-8 p-10 bg-[#080808] border border-zinc-900 rounded-[2.5rem] text-center shadow-inner relative overflow-hidden group">
                         ...
                         <div className="space-y-3">
                            <h5 className="text-[9px] font-black text-zinc-500 uppercase tracking-[0.3em]">Operational Note</h5>
                         ...
                         <a href="https://ai.google.dev/gemini-api/docs/billing" target="_blank" className="text-[8px] font-black text-blue-500/50 hover:text-blue-500 uppercase tracking-widest underline underline-offset-4 transition-colors">VIG-BILLING-STD</a>
                      </div>
                   </div>
                </div>
              )}
                ...
                <div className="text-center space-y-10 p-12 animate-in zoom-in duration-500 relative z-10">
                   ...
                   <div className="space-y-6">
                      ...
                      <div className="flex flex-col items-center gap-4">
                        <button 
                          onClick={handleSelectKey}
                          className="px-10 py-4 bg-red-600 text-white rounded-xl text-[11px] font-black uppercase tracking-[0.4em] hover:bg-red-500 transition-all shadow-xl flex items-center justify-center gap-3"
                        >
