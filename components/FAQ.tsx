      ...
      <div className="max-w-5xl mx-auto space-y-16">
        ...
        <div className="pt-12 flex flex-col md:flex-row items-center justify-between gap-8 border-t border-zinc-800">
           <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-2xl bg-zinc-900 flex items-center justify-center border border-zinc-700">
           ...
           <button 
             ...
             className="px-8 py-4 bg-zinc-900 border border-zinc-700 text-zinc-300 text-[10px] font-black uppercase tracking-widest rounded-xl hover:text-white hover:border-blue-500/50 transition-all active:scale-95"
           >
             VIEW REGISTRY DOCS
           </button>
        </div>
