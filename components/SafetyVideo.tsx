...
const ArchitecturalFlowCard = () => (
  <div className="w-full p-6 md:p-12 lg:p-16 bg-[#030712] border border-blue-900/30 rounded-[1.5rem] md:rounded-[28px] shadow-2xl relative overflow-hidden mb-0 group">
