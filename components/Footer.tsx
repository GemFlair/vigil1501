      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-0 lg:divide-x lg:divide-zinc-900/40 mb-12">
        ...
        <div className="lg:px-12 space-y-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 group cursor-default">
              <MirrorMail className="w-3.5 h-3.5 text-zinc-600 group-hover:text-blue-400 transition-all" />
        ...
        <div className="lg:px-12 space-y-12">
          <div className="space-y-6">
            ...
            <ul className="space-y-5">
              <li><button onClick={() => onOpenDoc('pricing')} className="text-xs font-black text-zinc-400 hover:text-white transition-all text-left flex items-center gap-4 uppercase tracking-[0.2em] group/link">
                <Tag className="w-4 h-4 text-zinc-600 group-hover:text-emerald-500 transition-colors" /> Plans & Access
              </button></li>
              <li><button className="text-xs font-black text-zinc-800 cursor-not-allowed text-left flex items-center gap-4 uppercase tracking-[0.2em] group/link">
                <BookOpen className="w-4 h-4 text-zinc-800" /> Operational Manual
              </button></li>
              <li><button className="text-xs font-black text-zinc-800 cursor-not-allowed text-left flex items-center gap-4 uppercase tracking-[0.2em] group/link">
                <Share2 className="w-4 h-4 text-zinc-800" /> Media Kit
              </button></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-5">
              <li><button className="flex items-center gap-4 text-xs font-black text-zinc-800 cursor-not-allowed text-left uppercase tracking-[0.2em] group/link">
                <Fingerprint className="w-4 h-4 text-zinc-800" /> Identity Manifest
              </button></li>
