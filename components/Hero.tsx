...
const TypingHeadline = ({ text, delay = 500, startTrigger = true }: { text: string; delay?: number; startTrigger?: boolean }) => {
  ...
  return (
    <h1 className="text-[2.25rem] md:text-[3.8rem] font-black tracking-tighter leading-[0.8] uppercase italic select-none min-h-[1em] relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          <div className="lg:col-span-7 space-y-6 md:space-y-12">
            <div className="space-y-4 md:space-y-10">
              ...
              <div className="space-y-2">
                <h1 className="text-[2.25rem] md:text-[3.4rem] font-black tracking-tighter leading-[0.8] text-white uppercase italic select-none">THE INTENT</h1>
