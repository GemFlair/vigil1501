      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
           ...
           <div className="lg:col-span-4 space-y-8">
              ...
              <div className="p-8 bg-cyan-950/20 border-2 border-cyan-500/20 rounded-[2.5rem] space-y-6 animate-in slide-in-from-left duration-1000">
                <div className="flex items-center gap-4">
                  <Radar className="w-8 h-8 text-cyan-500 animate-pulse" />
                  <div className="space-y-1">
                    <span className="text-[10px] font-black text-cyan-500 uppercase tracking-[0.4em]">Next Sector: [MESH]</span>
                    <h4 className="text-xl font-black text-white italic uppercase tracking-tight">Intelligence Terminal.</h4>
                  </div>
                </div>
                <p className="text-[11px] text-zinc-400 font-bold leading-relaxed italic uppercase">
                  Reveal the Sentinel AI Intelligence core. This terminal allows conversational queries to the kernel for bit-perfect technical assistance.
                </p>
              </div>
