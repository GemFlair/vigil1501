...
const FeatureCard: React.FC<FeatureCardProps> = ({ feature, index, delayOffset }) => {
  ...
  return (
    <div 
      ...
      className={`group p-6 md:p-10 bg-[#080808] border border-zinc-700 rounded-[16px] relative h-full transition-all duration-[600ms] will-change-transform overflow-hidden ${
    ...
    <div ref={sectionRef} className="space-y-4 md:space-y-12 py-4 md:py-8 overflow-x-hidden">
      <section id="features" className="px-1 md:px-20 max-w-7xl mx-auto scroll-mt-20">
        <div className="text-center space-y-4 md:space-y-6 mb-10 md:mb-16">
          ...
          <h2 className={`text-3xl md:text-7xl font-black text-white italic uppercase tracking-tighter leading-none transition-all duration-700 delay-[100ms] ${headerVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>Wallet Safety Co-pilot</h2>
