...
import { Shield, FileText, Binary, Layers, Terminal, AlertCircle, Lock, Cpu, Target, ShieldAlert, Database, History, Fingerprint, Activity, Gauge } from 'lucide-react';
    ...
    <div className="space-y-12 md:space-y-16 px-1 md:px-12 relative z-10">
      ...
      <DocCard border="blue" glow>
        ...
        <div className="space-y-8 md:space-y-10">
          ...
          <ClauseFrame id="VIG-ARCH-LATENCY">
