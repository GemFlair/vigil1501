        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5">
             <TechNote title="INTEL SOURCE">
                Derived from the 2025 Solana Ecosystem Threat Audit and Chainalysis Oct 2024 Forensic Briefing. Adversaries are prioritized by ROI potential (1,147% realized avg).
             </TechNote>
          </div>
        </div>
      </section>
