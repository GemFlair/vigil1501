...
export const ResearchBriefingContent = () => (
  <div className="space-y-24 pb-60 max-w-6xl mx-auto selection:bg-blue-500/20 relative">
    ...
    <div className="space-y-32 px-6 md:px-12 relative z-10">
        ...
        <DocCard border="blue" glow>
          ...
          <div className="space-y-6 text-zinc-400 text-lg leading-relaxed font-medium">
            ...
            <p className="pt-4 border-t border-zinc-900/50">
              Forensic intelligence from Chainalysis (Oct 2024) reveals the emergence of "Plug-and-Play" poisoning toolkits on Darknet marketplaces. These toolkits provide automated Look-alike Generation, campaign orchestration, and customer support, drastically lowering the technical barrier for "Spear-Poisoning" operations.
            </p>
          </div>
        </DocCard>
        ...
        <DocCard border="red">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              <div className="p-8 bg-zinc-950 border border-zinc-900 rounded-3xl space-y-4">
                 <TechLabel text="REALIZED ROI" color="emerald" />
                 <div className="text-4xl font-black text-emerald-500 italic">1,147%</div>
                 <p className="text-xs text-zinc-500 font-bold uppercase tracking-widest leading-relaxed">
                   Real-world campaign yield identified by Chainalysis, representing a 12.47x return on adversarial compute cost.
                 </p>
              </div>
              <div className="p-8 bg-zinc-950 border border-zinc-900 rounded-3xl space-y-4">
                 <TechLabel text="POTENTIAL ROI" color="blue" />
                 <div className="text-4xl font-black text-white italic">58,363%</div>
                 <p className="text-xs text-zinc-500 font-bold uppercase tracking-widest leading-relaxed">
                   Theoretical upper-bound efficiency for automated vanity generation at current hardware prices (584x cost).
                 </p>
              </div>
           </div>
      ...
      {/* PAGE 4: HIGH-VALUE TARGET PROFILING (NEW) */}
      <section className="space-y-12">
        <div className="flex items-center gap-6">
          <TechLabel text="INTEL: 04.0" color="blue" />
          <div className="h-[1px] flex-1 bg-zinc-900" />
        </div>
        ...
        <DocCard border="blue">
           <div className="flex items-center gap-4 mb-8">
              ...
              <h3 className="text-3xl font-black text-white italic uppercase tracking-tight">04. High-Value Target Profiling</h3>
           </div>
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
              <div className="lg:col-span-7 space-y-6">
                 <p className="text-zinc-400 text-lg leading-relaxed font-medium">
                   Adversarial telemetry refutes the assumption that only beginner users are at risk. Chainalysis forensic reconstruction of the 2024 campaign reveals that attackers explicitly target <b>Experienced Wallets</b>.
                 </p>
                 <div className="grid grid-cols-2 gap-4">
                    <div className="p-6 bg-black border border-zinc-900 rounded-2xl">
                       <div className="text-[10px] font-black text-zinc-600 uppercase tracking-widest mb-1">Avg. Activity Depth</div>
                       <div className="text-2xl font-black text-white italic">512 Days</div>
                    </div>
                    <div className="p-6 bg-black border border-zinc-900 rounded-2xl">
                       <div className="text-[10px] font-black text-zinc-600 uppercase tracking-widest mb-1">Avg. Transfer Count</div>
                       <div className="text-2xl font-black text-white italic">598 Tx</div>
                    </div>
                 </div>
              </div>
              <div className="lg:col-span-5 space-y-6">
                 <div className="p-8 bg-zinc-950 border border-zinc-900 rounded-[2.5rem] space-y-4">
                    <h5 className="text-[11px] font-black text-white uppercase tracking-widest">The "Experience Trap"</h5>
                    <p className="text-xs text-zinc-500 leading-relaxed font-medium italic">
                      High-volume traders are more likely to rely on visual edge anchors and "Recent Transaction" lists, making them vulnerable to long-con history poisoning. Confidence is a primary attack vector.
                    </p>
                 </div>
              </div>
           </div>
      ...
      {/* PAGE 5: THE PAVLOVIAN APPROVAL MATRIX */}
      <section className="space-y-12">
        <div className="flex items-center gap-6">
          <TechLabel text="BEHAVIORAL: 05-B" color="purple" />
          <div className="h-[1px] flex-1 bg-zinc-900" />
        </div>
      ...
      {/* PAGE 6: DOM MUTATION LATENCY */}
      <section className="space-y-12">
        <DocCard border="cyan">
           <div className="flex items-center gap-4 mb-8">
              <Gauge className="w-8 h-8 text-cyan-500" />
              <h3 className="text-3xl font-black text-white italic uppercase tracking-tight">06. Interception Latency Requirements</h3>
           </div>
      ...
      {/* PAGE 7: CSS HOMOGRAPH ATTACKS */}
      <section className="space-y-12">
        <div className="flex items-center gap-6">
          <TechLabel text="UI_THREAT: 07-C" color="orange" />
          <div className="h-[1px] flex-1 bg-zinc-900" />
        </div>
        ...
        <DocCard border="blue">
           <div className="flex flex-col md:flex-row gap-12 items-center">
              ...
              <div className="flex-1 space-y-8">
                 <h3 className="text-3xl font-black text-white italic uppercase tracking-tight">08. Temporal Drift Metrics</h3>
                 <p className="text-zinc-400 text-lg leading-relaxed font-medium">
      ...
      {/* PAGE 10: CITATIONS & BIBLIOGRAPHY */}
      <section className="pt-24 space-y-16 scroll-mt-24" id="bibliography">
        <DocCard border="zinc">
           <div className="flex items-center gap-4 mb-10 border-b border-zinc-900 pb-6">
              ...
              <h3 className="text-2xl font-black text-white italic uppercase tracking-tight">10. Citations & Bibliography</h3>
           </div>
           <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-10">
              {[
                ...
                { 
                  id: "ONCHAIN-POI", 
                  title: "Chainalysis: Anatomy of an Address Poisoning Scam", 
                  desc: "Detailed reconstruction of the 0xd9A1 whale attack and experienced user targeting.",
